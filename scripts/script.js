...
function createPathSejarah(){  
    ...
    CreateConnectPath(titik1, titik2, "black", "dash", "mid", "mid", "-1")
    CreateConnectPath(titik2, titik3, "black", "dash", "mid", "mid", "-1")
    CreateConnectPath(titik3, titik6, "black", "dash", "mid","right", "-1")
    CreateConnectPath(titik4, titik5, "black", "dash", "mid", "bottom", "-1")
    CreateConnectPath(titik7, titik8, "black", "dash", "left", "bottom", "-1")
    CreateConnectPath(titik9, titik10, "black", "dash", "right", "top", "-1")
    CreateConnectPath(titik10, titik10, "black", "dash", "top", "bottom", "-1")
    CreateConnectPath(titik11, titik12, "black", "dash", "right", "top", "-1")
    CreateConnectPath(titik12, titik12, "black", "dash", "top", "bottom", "-1")



    CreateConnectPath(titik1M, titik2M, "black", "dash", "mid", "mid", "-1")
    CreateConnectPath(titik1M, titik3M, "black", "dash", "mid", "left", "-1")
    CreateConnectPath(titik1M, titik4M, "black", "dash", "mid", "left", "-1")
    CreateConnectPath(titik1M, titik5M, "black", "dash", "mid", "left", "-1")
    CreateConnectPath(titik1M, titik6M, "black", "dash", "mid", "left", "-1")
    CreateConnectPath(titik1M, titik7M, "black", "dash", "mid", "left", "-1")
    CreateConnectPath(titik1M, titik8M, "black", "dash", "mid", "left", "-1")
    CreateConnectPath(titik1M, titik9M, "black", "dash", "mid", "left", "-1")
